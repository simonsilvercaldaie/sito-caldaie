...
async function processImage() {
    ...
    // 1. CLEANED 1024x1024 base image
    // Make sure the rectangles are tall enough to catch all ascenders/descenders (like 'p' in completamento)
    const svgMask = `
        <svg width="1024" height="1024">
            ...
            <rect x="150" y="710" width="724" height="45" fill="#fefdf9" />
            <!-- Rewrite just SIMON SILVER CALDAIE -->
            <text x="512" y="742" font-family="Times New Roman, Times, serif" font-weight="bold" font-size="28" fill="#1a2640" text-anchor="middle">SIMON SILVER CALDAIE</text>
            
            <!-- Mask Date (Left side only, massive block to catch all descenders) -->
            <rect x="120" y="825" width="460" height="60" fill="#fefdf9" />
        </svg>
    `;
    ...
    const destPath = 'C:\\\\Users\\\\simon\\\\.gemini\\\\antigravity\\\\brain\\\\f85c78f2-6ba9-4949-983d-7daff641369e\\\\optimized_portrait_v2.png';
    fs.copyFileSync(finalPath, destPath);

    console.log('Successfully created, masked, and stretched portrait A4 image v2!');
}
