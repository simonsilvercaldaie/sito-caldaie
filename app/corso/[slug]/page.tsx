...
export default function CorsoPage() {
    ...
    const [activeOrderId, setActiveOrderId] = useState<string>("") // Per il watermark
        ...
        const checkUser = async () => {
            ...
            if (currentUser) {
                ...
                const { data: purchases } = await supabase
                    .from('purchases')
                    .select('product_code, paypal_capture_id, id') // Added paypal_capture_id/id
                    .eq('user_id', currentUser.id)

                let hasAccess = false
                let userCourseIds: string[] = []
                let orderLimitId = "" // Find the order ID that grants access
                ...
                if (hasAccess && !orderLimitId) {
                    // Se accesso tramite Team o altro, mettiamo un ID generico o recuperato altrove
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                <div className="space-y-4 pt-4">
                                    ...
                                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-accent/20 relative">
                                        {hasPurchased ? (
                                            // UTENTE HA ACQUISTATO: MOSTRA IL PLAYER SICURO
