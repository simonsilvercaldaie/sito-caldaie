                ...
                <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="prose prose-gray max-w-none text-gray-600 space-y-8">
                        ...
                        <section>
                            ...
                            <p className="mt-4"><strong>7.3.</strong> <strong>Turnover e Inviti Extra.</strong> Ogni licenza Multidipendente include un pacchetto di inviti gratuiti (pari al doppio dei posti, es. Multidipendente 5 = 10 inviti totali) pensati per gestire il normale turnover. Esauriti gli inviti gratuiti a disposizione, ogni ulteriore inserimento (per formare una nuova singola persona oltre la quota consentita) richiede l'acquisto di un <strong>Invito Extra Monouso</strong> al costo di <strong>€400</strong>. L'Invito Extra non aumenta il numero di postazioni simultanee attive.</p>
                            <p className="mt-4">
                        ...
                        <section>
                            ...
                            <p className="mt-4"><strong>9.3.</strong> <strong>Limite dispositivi e tracciamento:</strong> Ogni account autorizza l'associazione di un massimo di <strong>2 dispositivi fisici</strong> (es. un PC e un telefono) per la visione dei Contenuti Premium. Il sistema di sicurezza identifica i dispositivi in base all'impronta del browser (User Agent) e mediante la registrazione di un "token di sessione" (cookie/local storage) nel browser web utilizzato dall'Utente.</p>
                            <ul className="list-disc pl-6 mt-2 space-y-1">
                                <li><strong>Cancellazione Dati:</strong> La formattazione del dispositivo, l'utilizzo frequente della "Navigazione in Incognito", il cambio di browser (es. da Chrome a Safari sullo stesso PC) o la cancellazione manuale della cronologia, cache e cookie del browser comportano la disconnessione e l'eliminazione del token di riconoscimento.</li>
                                <li><strong>Nuova Associazione:</strong> Qualora l'utente acceda nuovamente dopo aver effettuato tali azioni, il sistema di sicurezza registrerà un "nuovo" dispositivo, occupando inevitabilmente il secondo slot disponibile, pur trattandosi dello stesso hardware. L'Azienda non può essere ritenuta responsabile per l'esaurimento degli slot derivante da abitudini di navigazione che cancellano i dati locali.</li>
                            </ul>
                            <p className="mt-4"><strong>9.4.</strong> <strong>Ripristino Dispositivi:</strong> A tutela degli Utenti in caso di furto, rottura o regolare cambio del dispositivo, è garantita la facoltà di resettare autonomamente la lista dei propri dispositivi dall'area "Il Mio Account". Tale operazione di ripristino universale è consentita per un massimo di <strong>1 volta ogni 30 giorni solari</strong>.</p>
                            <p className="mt-4"><strong>9.5.</strong> I Contenuti possono riportare una filigrana digitale contenente l'indirizzo email dell'utente, a fini di tutela della proprietà intellettuale.</p>
                        </section>
