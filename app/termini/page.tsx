                ...
                <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="prose prose-gray max-w-none text-gray-600 space-y-8">
                        ...
                        <section>
                            ...
                            <p className="mt-4"><strong>7.3.</strong> <strong>Turnover e Inviti Extra.</strong> Ogni licenza Multidipendente include un pacchetto di inviti gratuiti (pari al doppio dei posti, es. Multidipendente 5 = 10 inviti totali) pensati per gestire il normale turnover. Esauriti gli inviti gratuiti a disposizione, ogni ulteriore inserimento (che comporti l'aggiunta permanente di un nuovo individuo allo storico aziendale) richiede l'acquisto di un <strong>Invito Extra</strong> al costo di <strong>€400</strong>. L'Invito Extra non aumenta il numero di postazioni simultanee attive.</p>
                            <p className="mt-4">
